...
[Email](mailto:iamluckyanish9304@gmail.com) · [LinkedIn](https://www.linkedin.com/in/luckyanish136) · [Portfolio](https://portfolio-neon-seven-10.vercel.app) · [GitHub](https://github.com/Lucky136-code)
...
### [RAG Domain Chatbot](https://github.com/Lucky136-code/RagChatBot)
`Python` `LangChain` `FAISS / ChromaDB` `HuggingFace` `FastAPI` `React`
